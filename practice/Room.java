...
{    
    ...
    Room(boolean FL, boolean KF, boolean GN, boolean LT, boolean ST, boolean RB, int MD, int AO,int RN, String RM, int CRN, int CRS, int CRE, int CRW,boolean RD, boolean RS, boolean ER){
        this.FLASHLIGHT = FL;
        this.KNIFE = KF;
        this.GUN = GN;
        this.LIGHTER = LT;
